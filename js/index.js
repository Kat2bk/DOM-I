...
// features
let featureTitle = document.querySelectorAll(
...
let servicePara = document.querySelectorAll(
...
let productPara = document.querySelectorAll(
  ".main-content .bottom-content .text-content p"
)[1];
...
let visionPara = document.querySelectorAll(
  ".main-content .bottom-content .text-content p"
)[2];
...
const greenNavi = document.querySelectorAll("a");
greenNavi.forEach(function(item) {
